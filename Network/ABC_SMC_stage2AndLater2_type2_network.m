...
while(condition)
    ...
    keyboard
    if samplingStrategy == 2 && mod(CONFIG.configID,2) == 1 && CONFIG.configID>40
        [POPULATION_2] = newFreeFlowSamplingStra(POPULATION_2, mean_travelTimes, var_travelTimes, sensorMetaDataMap, linkMap, travel_times_new);
    end
